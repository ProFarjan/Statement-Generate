    ...
    <div class="row align-items-center">
        <div class="col-md-6">
            <a href="<?=site_url('welcome/brac_bank');?>">
                <img src="<?=site_url('assets/images/brac_bank.png') ?>" target="_blank" width="320px" />
            </a>
        </div>
        <div class="col-md-6">
            <a href="<?=site_url('welcome/home');?>">
                <img src="<?=site_url('assets/images/logo.png') ?>" target="_blank" width="320px" />
            </a>
        </div>
        <div class="col-md-6">
            <a href="<?=site_url('welcome/ddbl_bank');?>">
                <img src="<?=site_url('assets/images/ddbl.png') ?>" target="_blank" width="320px" />
            </a>
        </div>
    </div>
</section>
