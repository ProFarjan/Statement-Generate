...
<body>
	...
	<form action="<?= site_url('welcome/save_brac')?>" method="post">
		<div class="container mt-4">
			...
			<div class="row mt-5">
				<div class="col-md-6">
					...
					<div class="row mb-3"></div>
					<div class="row mb-3">
						<label for="reff" class="col-sm-2 col-form-label">REF</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="reff" name="reff" placeholder="Enter REF" />
						</div>
					</div>
				</div>
				<div class="col-md-6">
